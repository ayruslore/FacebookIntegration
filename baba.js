...
var query= url + "response.result.parameters.area";
...
client.get(query, function (data, response) {
   ...
   // aiText="wait";
    for(x in data){
      ...
      qs: {access_token:'EAABymJOpyMABAPQ4Bw6IPALZChBcmEI9dTOWZBTanr2ZBXBdTUHBRqJLzxUHOsUVt2Pj55ZBsrNZBsz3SFQVXEK3qlKLLr0lxUXm1fjWBK2JjUHJN1BAoi1gZAAVodbkKh7nFpGQQh1puffIhQBsUGLy2VfcoM1uvT653vJZBqVIwZDZD' },
      method: 'POST',
      json: {
        recipient: {id: sender},
        message: {text: aiText}
...
/*function sendGenericMessage_persistent(recipientId,text){
 ...
 request({
    ...
    qs: { access_token:'EAABymJOpyMABAEfPI2V3P0ilrGwMfpJBGiIhGZCpsNzVj2IsRO9XVSnmNvvaJwgbG0zJAOwdtUDYgzke2ZC2dryAZC76jxZCEOLn48tz9euJf1fjmfElhFBqoHxPSPdsLVQWSRuJrncP3ixscdz5HYWZAMZBVXZBESW8iIkPvDHCwZDZD'},
    method: 'POST',
    json:{
  "get_started":{
