...
let token = 'EAACVKZCVBcZCcBADdm1cRH0jCV7AY7zTYejK6RF2iki6tWKLd5FU7ARAAKCkTcjYR9PgcUJIOQG5VK76l4yUPyY942vT8mCqKFcq8T2QiqZAs9rBBDIlNbiNsX1pzcaNBjyYF6YygfZAfCdUiq910IXAyVsIH9QB2YuY36ipGQZDZD';
...
function callSendRedisapi(tag,operation,sender,aiText){
        request_1.getAsync({
                ...
                if (tag==='add'){
                        ...
                        sendButton(sender,["postback"],"Your order status is: Pending",["order_status"],["Check Status"]);
                }
                else if (tag==='receipt'){
                        var keys =[];
                        var quantity=[];
